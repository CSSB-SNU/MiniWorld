"""Validation-only sweep without EMA parameters for atom_token_explicit variant.

Based on scripts/run_af3like_explicit_rev.py
(ExplicitClient_rev + af3_like_explicit.Model_rev).
