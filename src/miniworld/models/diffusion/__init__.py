"""phase 2: EDM diffusion module on top of a FROZEN pair-only mini-SWA trunk.

The trunk is the phase 1b ``MiniSWAModel`` (distogram-only, pair-only). phase 2
...
from .model import Model, ModelWrapper, DiffusionModel
