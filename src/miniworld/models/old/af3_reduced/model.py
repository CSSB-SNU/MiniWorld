...
from miniworld.modules.diffusion_module_reduced import (
...
class AF3ReducedModel(nn.Module):
    """Structure AF3Reduced model."""
    ...
    class Config(BaseModel):
        """Configuration for the AF3Reduced model."""

        shared: SharedConfig
        input_feat_embbeder: DiffusionTransformer.Config
        trunk: "AF3ReducedModel.TrunkConfig"
        diffusion: "AF3ReducedModel.DiffusionConfig"
    ...
    def forward(
        ...
        """Forward pass of the AF3Reduced model."""
        (
            token_single_input,
            token_single_trunk,
            token_pair_trunk,
...
class AF3ReducedModelWrapper(nn.Module):
    """Wrapper for AF3ReducedModel to handle the input and output using solver."""

    def __init__(self, model: AF3ReducedModel) -> None:
        super().__init__()
...
@dataclass
class AF3ReducedInferenceOutput:
    """Output of the AF3Reduced model inference."""
