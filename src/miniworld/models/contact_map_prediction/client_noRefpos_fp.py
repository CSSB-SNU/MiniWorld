...
from .model_noRefpos_fp import ContactMapPredictionModel
...
class ContactMapPredictionClient(BaseClient):
    ...
    def predict_contact_map(
        ...
        if save_dir is not None:
            ...
            pred_only_path = save_dir / f"{batch.name[0]}_noRefposFp_pred_only.png"
            target_only_path = save_dir / f"{batch.name[0]}_noRefposFp_target_only.png"
