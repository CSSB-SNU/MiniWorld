...
from .modules import MSAModule, Pairformer


class AF3NattenModel(nn.Module):
    ...
    class Config(BaseModel):
        """Configuration for the AF3Natten model."""

        shared: SharedConfig
        input_feat_embbeder: DiffusionTransformer.Config
        trunk: "AF3NattenModel.TrunkConfig"
        diffusion: "AF3NattenModel.DiffusionConfig"
    ...
    def forward(
        ...
        """Forward pass of the AF3Natten model."""
        (
            token_single_input,
            token_single_trunk,
            token_pair_trunk,
...
class AF3NattenModelWrapper(nn.Module):
    """Wrapper for AF3NattenModel to handle the input and output using solver."""

    def __init__(self, model: AF3NattenModel) -> None:
        super().__init__()
...
@dataclass
class AF3NattenInferenceOutput:
    """Output of the AF3Natten model inference."""
